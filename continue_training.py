...
if __name__ == '__main__':
    ...
    training_timesteps = 600000  # Number of timesteps for additional training
    saved_model_dir = "/Desktop/workspaces/mindstorm_project_RL/saved_models/jan3_rppo_2m200k"
