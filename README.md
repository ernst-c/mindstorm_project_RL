...
- curriculum_learning_disc_actions -->  curriculum learning approach
- curriculum_lrf_obs_disc --> curriculum learning approach, observation space only contains laser range finder inforamtion
