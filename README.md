...
<div align='center'>
    ...
    <tr>
        <td align="center">
        <img src="assets/gifs/discrete_action_space.gif" alt="discrete_action_space" title="discrete_action_space" width="400">
        <br>
        <b>Discrete action space</b>
        </td>
        <td align="center">
        <img src="assets/gifs/continuous_action_space.gif" alt="continuous_action_space" title="continuous_action_space" width="400">
        <br>
